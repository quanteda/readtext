...
#         encodedreadtextsCorpus <- corpus(readtext(filenames, encoding=fileencodings))
#     })
# })
# 
...
#     expect_equal(
#         unname(sort(texts(corpus(readtext('../data/tar/test.tar'))))),
...
#     expect_equal(
#         sort(unname(texts(corpus(readtext('../data/targz/test.tar.gz'))))),
#         c('brown fox', 'Dolor sit', 'Lorem ipsum', 'The quick')
#     )
# })
# 
...
#     skip_on_os("windows")
#     expect_equal(
#         sort(unname(texts(corpus(readtext('../data/tarbz/test.tar.bz'))))),
#         c('brown fox', 'Dolor sit', 'Lorem ipsum', 'The quick')
#     )
# })
