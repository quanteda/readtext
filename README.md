...
## Warning in if (options("readtext-verbosity")[[1]] >= 2) message("possible
## glob pattern"): the condition has length > 1 and only the first element
## will be used
## possible glob pattern
## Warning in if (options("readtext-verbosity")[[1]] >= 2) message("regular
## file"): the condition has length > 1 and only the first element will be
## used
## regular file
## Warning in if (options("readtext-verbosity")[[1]] >= 2) message("regular
## file"): the condition has length > 1 and only the first element will be
